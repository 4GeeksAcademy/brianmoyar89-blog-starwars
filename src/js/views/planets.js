...
const Planets = () => {
  ...
  const imageToDisplay = (idCard == 1) ? `https://i1.wp.com/www.sinembargo.mx/wp-content/uploads/2014/07/tatooine.jpg?w=570&quality=80&strip=all&ssl=1` : `https://starwars-visualguide.com/assets/img/planets/${idCard}.jpg`;
    ...
    <>
      <div className="container mt-5 d-flex">
        ...
        <div className="mx-2 text-center">
          <h1 className="text-dark mt-0">{store.planetsInfo ? store.planetsInfo.name : "loading..."}</h1>
